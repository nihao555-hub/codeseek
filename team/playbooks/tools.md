...
| 会话顶栏看 agent | 官方 `conversation.view`（和 Chat 并列）；不装 [omdsh-dev/DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | `plugins/activity-panel`，`GET /__codeseek/activity` |
